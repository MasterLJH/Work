...
namespace BingLibrary.hjb.tools
{
    ...
    public static class EncryptUtil
    {
        public static void GetSystemInfo()
        {
            try
            {
                StreamWriter swd = new StreamWriter(Tool.CurrentPath() + "\\System.info", false, System.Text.Encoding.UTF8);
                string s = SysTool.GetCpuInfo();
                swd.WriteLine("E3F60BEF521F410FA31SF6KFJ35LGJVN50SDSNWK2KJFN6JAOP9LEC3Z3JGNC6J0KO03B16DE9EC91BG49867CC48C1944B78DE4" + s + "5C7870OJE7709A0B4763BA7B4F4AA9PLM1DH6BA93KM90E8WM9D87XBC66HNS079134B");
                swd.Close();
            }
            catch { }
        }

        public static void CreatLicense()
        {
            try
            {
                StreamWriter swd = new StreamWriter(Tool.CurrentPath() + "\\License.lic", false, System.Text.Encoding.UTF8);
                string s = SysTool.GetCpuInfo();
                string s1= EncryptUtil.Sha256(s); 
                
                swd.WriteLine("31753AE86A64DA8A2C273D5DE293D26" + s1 + "GB2D0340DBA54D29B2C9725D5233878D");
                swd.Close();
            }
            catch { }
        ...
        public static bool Checklicense() 
        {
            ...
            try
            {
                srd = new StreamReader(Tool.CurrentPath() + "\\License.lic", Encoding.Default, true);
            }
            catch { return false; }
            try
            {
                string s = SysTool.GetCpuInfo();
                string str1 =EncryptUtil.Sha256(s);
